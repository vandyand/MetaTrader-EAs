...
//------------------------------------------------------------------------------------------
//Notes:
//Golf is the same as foxtrot except it writes the actual trade profits to the file (in 
//string form separated by colons ':') instead of summary stats. For this reason the summary
//stats function only returns the trades profits and all the analysis is being done in
//python.
//
//------------------------------------------------------------------------------------------
...
void OnTick(){
   ...
   if(New_Bar&&!first_pass&&((Long_Back_1!=Long_Back_2)||(Short_Back_1!=Short_Back_2))&&Open_Bars>1){
