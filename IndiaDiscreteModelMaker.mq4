...
//------------------------------------------------------------------------------------------
//Notes:
//India is copied from Golf. It does the same thing to golf as hotel did to foxtrot which is
//it drops OpenBars parameter and instead uses longcond and shortcond exclusively for
//opening and closing long and short trades. Basically when longcond==shortcond no open
//trades, else when longcond=1 and shortcond=0 go long and vice versa.
//
//------------------------------------------------------------------------------------------
...
extern int Open_Bars;//empty variable kept for analysis with python
...
extern int num_trades_thresh = 1;//Magic
