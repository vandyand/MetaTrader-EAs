...
void OnTick()
{
   ...
   double adx_diplus = iADX(Symbol(),Period(),ADX_Period,0,MODE_PLUSDI,0);
   double adx_diminus = iADX(Symbol(),Period(),ADX_Period,0,MODE_MINUSDI,0);
